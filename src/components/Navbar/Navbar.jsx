...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      <li className="hover:text-brand-secondary dark:hover:text-yellow-400 dark:text-gray-50 duration-300 ">
        <NavLink
          to="/"
          className={({ isActive, isPending }) =>
            isPending
              ? "pending"
              : isActive
              ? "text-brand-primary dark:text-yellow-400 dark:focus:text-yellow-400"
              : ""
          }
        >
          Home
      ...
      <li className="hover:text-brand-secondary duration-300 dark:hover:text-yellow-400 dark:text-gray-50">
        <NavLink
          to="/addProduct"
          className={({ isActive, isPending }) =>
            isPending
  ...
  return (
    <div className="shadow-md  dark:bg-gray-900">
      ...
      <div className="container mx-auto px-6 lg:px-8 navbar py-4">
        <div className="justify-start flex-grow">
          <div className="dropdown z-20 dark:text-yellow-400">
            <label
              tabIndex={0}
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content border-2 border-brand-primary dark:bg-gray-900 dark:border-white mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52"
            >
              {navLinks}
            </ul>
          </div>
        ...
        <div className="justify-end flex-grow">
          {user ? (
            <div className="dropdown dropdown-end">
              <div
                tabIndex={0}
                className="group  cursor-pointer duration-300 hover:text-brand-primary dark:text-white dark:hover:text-yellow-400 flex justify-center items-center border-2 hover:border-brand-primary dark:hover:border-yellow-400 rounded-full pr-2"
              >
                <label className="md:w-14 w-11 avatar cursor-pointer align-bottom">
                  <div className="rounded-full ring-2 duration-300 dark:group-hover:ring-yellow-400 group-hover:ring-brand-primary ring-gray-200">
                    {user?.photoURL ? (
              ...
              <ul
                tabIndex={0}
                className="mt-3 p-2 z-20 shadow  dark:border-2 menu menu-sm dropdown-content bg-base-100 dark:bg-gray-900 rounded-box w-52"
              >
          ...
          <label className="swap swap-rotate ml-4">
            ...
            {/* sun icon */}
            <svg
              className="swap-on dark:fill-white fill-brand-primary w-10 h-10"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
            ...
            {/* moon icon */}
            <svg
              className="swap-off dark:fill-white fill-brand-primary w-10 h-10"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
