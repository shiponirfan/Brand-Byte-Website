...
const BrandsCard = ({ brand }) => {
  ...
  return (
    <div data-aos="fade-up" data-aos-delay="300" className=" relative group flex flex-col my-4 text-white shadow-md rounded-xl bg-clip-border bg-gradient-to-t from-brand-primary via-purple-500 to-pink-500">
