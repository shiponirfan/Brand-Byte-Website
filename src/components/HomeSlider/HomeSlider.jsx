      ...
      >
        ...
        <div className="hero min-h-home-h" style={{backgroundImage: 'url(/src/assets/images/home_slider/home_slider1.jpg)'}}>
            ...
            <div className="container mx-auto px-5 lg:px-8 text-white">
                    ...
                    <Link to='/brands'>
                    <button className="bg-brand-primary hover:bg-brand-secondary duration-300 text-white font-medium  text-lg  py-3 px-6 rounded-md flex justify-center items-center">Get Started</button>
                    </Link>
                </div>
            </div>
        </div>
        ...
        <div className="absolute top-1/2 -right-20 group-hover:right-6 rounded-md text-2xl cursor-pointer hover:bg-brand-primary hover:text-white duration-300 bg-white p-4 z-10 swiper-button-next">
        <HiOutlineArrowNarrowRight/>
        </div>
        <div className="absolute top-1/2 -left-20  group-hover:left-6 rounded-md text-2xl cursor-pointer hover:bg-brand-primary hover:text-white duration-300 bg-white p-4 z-10 swiper-button-prev">
