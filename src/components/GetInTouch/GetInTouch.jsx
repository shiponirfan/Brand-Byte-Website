            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-body-color mb-9 text-base leading-relaxed">
                  ...
                  reliability, and innovation. Whether you&apos;re a tech
                  enthusiast, an automotive aficionado, or simply someone who
              ...
              <div className="relative rounded-lg bg-white  dark:bg-gray-900  p-8 shadow-lg sm:p-12">
                <form onSubmit={handleGetInTouch}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-brand-primary border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
